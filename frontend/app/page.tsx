...
const decisionSteps = [
  ...
  { number: "04", title: "Test workable alternatives", body: "Try 30-minute starts and eligible crews across the operation day, rejecting every hard-constraint violation.", tone: "violet" },
    ...
    <main className="marketing-page">
      ...
      <section className="marketing-hero">
        <div className="marketing-hero-copy">
          ...
          <h1>Plan the day.<br /><em>Respect the heat.</em></h1>
          <p>Choose a site, generate a large fictional day of work, then let HeatShift combine hourly weather, crew risk factors and scheduling constraints to build a lower-exposure alternative.</p>
      ...
      <section className="decision-method" id="method">
        <div className="section-heading method-intro"><span className="section-number">04</span><span className="eyebrow">How the proposal is made</span><h2>HeatShift searches for a better day, not an impossible one.</h2><p>The calculation is deterministic: the same weather, policy and simulated operation produce the same result. It searches within each job's daily window and rejects any schedule that breaks the operation.</p></div>
      ...
      <section className="evidence-boundaries" id="evidence">
        <div className="section-heading evidence-boundary-heading"><span className="section-number">07</span><span className="eyebrow">What is real—and what is simulated</span><h2>Three data layers, clearly separated.</h2><p>Provider evidence, stochastic fictional operations and HeatShift-derived values are labeled separately. Cached evidence is never presented as belonging to another location.</p></div>
        <div className="real-fiction-grid">
          <article className="real-evidence-card"><div className="boundary-card-head"><i /> <span>Real provider and research evidence</span></div><ul><li>One cached FortyGuard day for each of the three built-in sites</li><li>Hourly environmental conditions and 100m thermal cells</li><li>Provider activity IDs and integrity hashes</li><li><strong>566</strong> public HEAT-SHIELD exposure sessions</li><li>Independent reproduction of published benchmark calculations</li></ul></article>
